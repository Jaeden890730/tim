...
public class MainRouteSubAction extends Action {
  public ActionForward execute(ActionMapping actionMapping,
                               ActionForm actionForm,
                               HttpServletRequest Request,
                               HttpServletResponse servletResponse) {

    MainRouteSubForm fm_old = (MainRouteSubForm) actionForm;
    ...
    MainRouteSubForm fm = new MainRouteSubForm();
...
//      boolean chkPGexist = OiMaintainService.ChkPGToWsTx(pro_b, br, sid, version);
      ...
      mrs = MainRouteService.SelectAllFromMainRoute(sid, conn, pro_b, version, route_type);
    } catch (Exception e){
      e.printStackTrace();
    } finally {
    ...
    Request.setAttribute("mrsParam",mrs);
    forward = "mrsParam";
