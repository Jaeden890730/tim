...
*/
      ...
      if (listControl.equals("update_data")) {
        DocLinkageService.update_data(sid, pd_body, brand, version, doc_name, doc_name_be,
                                      comment, comment_be, seq, doc_type, "update_cmd");
      } else if (listControl.equals("submit_data")) {
        DocLinkageService.update_data(sid, pd_body, brand, version, doc_name, doc_name_be,
        							  comment, comment_be, seq, doc_type, "submit_cmd");
      }
      return actionMapping.findForward("update_data");
