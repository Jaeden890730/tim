...
import com.mxic.oiplus.xtrarom.oimaintain.OiMaintainStep;
...
public class oiMainControlAction extends Action {
  public ActionForward execute(ActionMapping actionMapping,
    ...
    String ra_select = "MX";// controlAFrom.getRa_select();
...
//      HttpSession session = servletRequest.getSession();
      ...
      IFInformationBean[] listall =
          oiSearchService.SelectIFinformation(txt_productbody);
      servletRequest.setAttribute("list", listall);
      ...
      if (bean == null) {
        ...
        IFInformationBean[] listall =
            oiSearchService.SelectSearchIFinformation(txt_productbody);
      ...
      if (status.equals("已生效")||status.equals("已失效")) {
        IFInformationBean listall =
            oiSearchService.SelectOneIFinformation(sid, txt_productbody, version);
