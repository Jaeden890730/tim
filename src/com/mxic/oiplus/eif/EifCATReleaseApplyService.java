...
public class EifCATReleaseApplyService {

  public EifCATReleaseApplyService() {
  }
  ...
  public static ArrayList getRecentlyOI(Connection conn) {
      ...
      try {
          ...
          sql = "select sid, product_body, brand, version, status, product_type from tf_information a, if_interface_time e " +
                  ...
                  "and e.interface = 'EifCATReleaseApply' \n" +
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ws_NVM(    ProTestRouteBeanAF fm,
                                         String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
    ...
    try {
      ...
      while(rs.next()){
          ...
          boolean result = CATRoutePgm_insert(conn, GroupKey, rs.getString("product_body"), rs.getString("brand"), 
        		  ...
        		  rs.getString("pgm_id"), rs.getString("programname"), rs.getString("actualprogramname"), product_type, rs.getString("hw_configure"));
          if(result == false)
        	  return false;
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ws_MCP_NVM(    ProTestRouteBeanAF fm,
                                         String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ws_MROM(    ProTestRouteBeanAF fm,
                                         String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ws_XROM(    ProTestRouteBeanAF fm,
                                         String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ft_NVM(    ProTestRouteBeanAF fm,
                                          String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ft_MCP_NVM(    ProTestRouteBeanAF fm,
                                          String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ft_MROM(    ProTestRouteBeanAF fm,
                                          String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ft_XROM(    ProTestRouteBeanAF fm,
                                          String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
...
//Write CAT ROUTE temp Data
  ...
  public static boolean insert_cat_route_tmp1(    ProTestRouteBeanAF fm,
		                                 String table,
		                                 String product_type,
                                         String status,
                                         Connection conn) {
    ...
    try {
      ...
      String sql = " select distinct a.productgroupkey, a.productbody, a.brand, a.version, a.status, a.maskbeoption, " +
                   ...
                   " from cat_route_pgm a, tf_product_route" + table + " b " +
                   " where a.productbody = ? " +
                   " and a.brand = ? " +
                   " and a.version = ? " +
                   " and a.status = ? " +
      ...
      while(rs.next()){
          ...
          boolean result = CATRouteTmp_insert(conn, rs.getString("productgroupkey"), rs.getString("productbody"), 
          ...
          boolean result2 = CATRouteTmp_insert(conn, rs.getString("productgroupkey"), rs.getString("productbody"), 
        		  rs.getString("brand"), rs.getString("version"), rs.getString("status"), rs.getString("updatetime"),
        		  rs.getString("routetype"), rs.getString("routename"), rs.getString("testseq"), rs.getString("stepname"), 
...
//Write CAT ROUTE temp Data
  ...
  public static boolean insert_cat_route_tmp2(    ProTestRouteBeanAF fm,
		                                 String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
    	...
    	while(chkMXICFlagYNNA(fm.getProductbody(), fm.getBrand(), fm.getVersion(), status, rs.getString("productgroupkey"), rs.getString("routetype"), rs.getString("routename")  )){
          ...
          while(rs_1.next()){
    	      ...
    	      if (!"NA".equals(rs_1.getString("flag"))){
    	    	...
    	    	boolean result = true;  
    	    	if(Curupdate!=null)  
    	    	   result = CATRouteTmp_update(conn, Curupdate, MXICFlag2);
    	    	...
    	    	if(TMPupdate!=null)
    	    	   result2 = CATRouteTmp_update(conn, TMPupdate, TMPupdate.get("testmode").toString());
    	  ...
    	  if(Curupdate != null && Curupdate.get("flag").equals("NA")){ //最後一筆為NA,設為前一筆資料,但在廠內(BAKE)則要顯示,EX: SORT1->BAKE1->SORT2->BAKE2
    		    ...
    		    if(BefMXICFlag2.startsWith("SUB")){
    	    	  result = CATRouteTmp_update(conn, Curupdate, BefMXICFlag2);
                }else{
                  result = CATRouteTmp_update(conn, Curupdate, TMPupdate.get("testmode").toString());	
    		    }  
    	    	if(result == false )
    	       	  return false;
...
//Write CAT ROUTE 
  ...
  public static boolean insert_cat_route(    ProTestRouteBeanAF fm,
                                         String status,
                                         Connection conn) {
      ...
      while(rs.next()){
          ...
          while(rs_1.next()){
        	  if(!TMPMXICFlag2.equals(rs_1.getString("flag"))) {
        		  seq ++;
        		  boolean result = CATRoute_insert(conn, rs_1.getString("productgroupkey"), rs_1.getString("productbody"), 
...
//Write CAT PGM vs CAT ROUTE, CAT ROUTE PGM
  ...
  public static boolean insert_cat_pgm(    ProTestRouteBeanAF fm,
		                                 String table,
                                         String status,
                                         String product_type,
                                         Connection conn) {
    ...
    try {
      ...
      String sql = " insert into cat_pgm " +
                   ...
                   " decode(substr(a.testmode,1,4),'TQAE', 'Q' ||substr(b.programname,2), b.programname) programname, hw_configure, b.j_grade, b.k_grade, b.l_grade, b.n_grade , b.b_grade , b.e_grade " +
                   " from cat_route a , cat_route_pgm b  " +
                   " where a.productbody = ? " +
                   " and a.brand = ? " +
                   " and a.version = ? " +
                   " and a.status = ? " +
  ...
  public static String getMXICFlag1(String productgroupkey, String productbody, String brand, String version,
	  ...
	  String result = null;
	  StringBuffer sqlStmt = new StringBuffer();
	  sqlStmt.append("SELECT COUNT(*) COUNT_NUM FROM CAT_ROUTE_PGM ");
...
//Set OI to desired status
  public static boolean CATRoutePgm_insert(Connection conn,
      ...
      String InsSQL1 = null;
      try {
          InsSQL1 = "insert into cat_route_pgm ";
          ...
          InsSQL1 += "  actualprogramname, product_type, pincount, hw_configure ) ";
          InsSQL1 += " values( ?, ?, ?, ?, ?, ";
...
//Set OI to desired status
  public static boolean CATRouteTmp_insert(Connection conn,
	  String productgroupkey, String productbody, String brand, String version,
      ...
      String InsSQL1 = null;
      try {
          InsSQL1 = "insert into cat_route_tmp ";
          InsSQL1 += "( productgroupkey, productbody, brand, version, status, ";
...
//Set OI to desired status
  public static boolean CATRoute_insert(Connection conn,
	  String productgroupkey, String productbody, String brand, String version,
	  String status, String updatetime,  String routetype, String routename, String testseq,
	  String testmode, String temperature, String testtime, String timeunit) {
...
//Set OI to desired status
  public static boolean CATRouteTmp_update(Connection conn, HashMap data, String flag ){
...
//Set OI to desired status
  public static boolean CATError_insert(Connection conn,
	  String productbody, String brand, String version, String status) {

      String InsSQL1 = null;
      String InsertSQL = null;
      try {
          InsSQL1 = "insert into cat_error ";
...
//      if ((add_route == null) || add_route.equals("null")) add_route = "";
  ...
  public static void insertMesTable(String product_body){
		...
		try {
			...
			String sql2 = 
				"INSERT INTO fwadmin.tbl_e8049_release@mesprod.world\n" +
...
//insert data to CAT_Route_Pgm
  public static boolean insert_cat_route_pgm_ft_MMS(    ProTestRouteBeanAF fm,
                                          String table,
                                         String product_type,
                                         String status,
                                         Connection conn) {
