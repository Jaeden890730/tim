...
public class MultipartRequest {
        ...
        */
        ...
        /**
        Return an String array of all values for the strName parameter.
        Even if a single value for, will always return an array, although
        it may actually be empty if not value was encountered for strName or
        it is an invalid parameter name.
        Sky 2002/08/28
        */
        public String[] getURLParameterStringArray(String strName) {
                Object value = htParameters.get(strName);

                if (value == null) value = "";
                if (value instanceof Vector) {
                        String[] tmparr = new String[((Vector) value).size()];

                        for (int i = 0; i < ((Vector) value).size(); i++) {
                                tmparr[i] = (String) (((Vector) value).elementAt(i));
                        }
                        return (tmparr);
                } else {
                        Vector vector = new Vector();
        ...
        */
        ...
        'Browse...' button of the <input type=file ...> input field.  This
        method was originally getFileSystemName, but now that MultipartRequest
        saves all files with a unique name, this is no longer relevant.
        ...
        */
        ...
        The getFileSystemName(),getFile(),getFileSize(),getContentType(),getContents() methods
 ...
 if (objArray != null && type >= FILENAME && type <= TMP_FILENAME)
        ...
        */
        ...
        } else// (strFilename!=null)
        {
         ...
         addFileParameter(strName, new Object[] {null, null, null, null, null}
                                                                                );
                ...
                } else // File uploaded, or at least a filename was specified, it could still be spurious.
                {
                        ...
                        } else// Read the file onto file system.
                        {
                                ...
                                if (fileOutPutDirectory != null) {
                                        ...
                                        outFile = TempFile.createTempFile(prefix, suffix, fileOutPutDirectory);
                                }
                        ...
                        if (filesize > 0)
                 addFileParameter(strName, new Object[] {strFilename, strContentType, new Long(filesize), contentsOfFile, outFile}
         );
         else // Zero length file.
                addFileParameter(strName, new Object[] {strFilename, null, new Long(0), null, null}
        );
                }
