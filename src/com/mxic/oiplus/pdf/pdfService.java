...
*/
  ...
  public static void addCell(PdfPTable tabExtend, String info, Font theFont, Color color) {
  ...
  public static PdfPTable tf_route_master_WSFT(PdfPTable tabExtend,
      ...
      sql2.append("select s1.product_body,s1.brand,s1.version,'"+route_type+"' type, s1.route_name\n");
      for (int i=1; i <16; i++) {
          sql2.append(",nvl(trim(s"+i+".step),'－') step"+i+", nvl(trim(s"+i+".stepr),'－') step"+i+"r\n");
      } 
      ...
      for (int i=1; i <16; i++) {
          ...
          sql2.append(" where sid = "+fm.getSid()+" and step_seq = "+i+") s"+i+",\n");
          if (i == 15) sql2.append("tf_route_master r\n");
      }

      sql2.append(" where\n");
      for (int i=2; i <16; i++) {
    	  if (i != 2) sql2.append("and ");
      ...
      String heading = "8049-"+fm.getProductbody()+"."+
      					OiMaintainService.getVendorShortName(conn, fm.getVendor())+"|"+
      					fm.getVersion()+"|"+fm.getProductbody()+"|"+fm.getBrand()+"|"+
      					(route_type.equals("W")?"WS|":"FT|");
      if (table.equals("") && !vendor.equals("") && !fm.getVendor().equals("TEST1")) {
    	  os = new FileOutputStream(textFilename+"-Route.txt",(route_type.equals("W")?false:true));
    	  pr = new PrintWriter(os);
      }
      //    select ecrtime for e8049 dat share project, Sophia
      String ecrtime[] = OiMaintainService.getEcrEffectTime(conn, fm.getProductbody(),fm.getVersion(),fm.getBrand());
      ...
      while (rs2.next()) {
        ...
        addCell(tabExtend, bean.getRoute_name(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep1(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep2(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep3(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep4(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep5(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep6(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep7(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep8(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep9(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep10(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep11(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep12(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep13(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep14(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep15(), theFont, (color==0?Color.LIGHT_GRAY:null));
        if (fieldRemark) 
            addCell(tabExtend, bean.getRemark(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, "rwk", theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep1r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep2r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep3r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep4r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep5r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep6r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep7r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep8r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep9r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep10r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep11r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep12r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep13r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep14r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        addCell(tabExtend, bean.getStep15r(), theFont, (color==0?Color.LIGHT_GRAY:null));
        
        e8049share.append(heading)
        .append(bean.getRoute_name()+"|")
        .append(bean.getStep1()+"|")
        .append(bean.getStep2().equals("－")?"":bean.getStep2()).append("|")
        .append(bean.getStep3().equals("－")?"":bean.getStep3()).append("|")
        .append(bean.getStep4().equals("－")?"":bean.getStep4()).append("|")
        .append(bean.getStep5().equals("－")?"":bean.getStep5()).append("|")
        .append(bean.getStep6().equals("－")?"":bean.getStep6()).append("|")
        .append(bean.getStep7().equals("－")?"":bean.getStep7()).append("|")
        .append(bean.getStep8().equals("－")?"":bean.getStep8()).append("|")
        .append(bean.getStep9().equals("－")?"":bean.getStep9()).append("|")
        .append(bean.getStep10().equals("－")?"":bean.getStep10()).append("|")
        .append(bean.getStep11().equals("－")?"":bean.getStep11()).append("|")
        .append(bean.getStep12().equals("－")?"":bean.getStep12()).append("|")
        .append(bean.getStep13().equals("－")?"":bean.getStep13()).append("|")
        .append(bean.getStep14().equals("－")?"":bean.getStep14()).append("|")
        .append(bean.getStep15().equals("－")?"":bean.getStep15()).append("|");
        e8049share.append(bean.getStep1r().equals("－")?"":bean.getStep1r()).append("|")
        .append(bean.getStep2r().equals("－")?"":bean.getStep2r()).append("|")
        .append(bean.getStep3r().equals("－")?"":bean.getStep3r()).append("|")
        .append(bean.getStep4r().equals("－")?"":bean.getStep4r()).append("|")
        .append(bean.getStep5r().equals("－")?"":bean.getStep5r()).append("|")
        .append(bean.getStep6r().equals("－")?"":bean.getStep6r()).append("|")
        .append(bean.getStep7r().equals("－")?"":bean.getStep7r()).append("|")
        .append(bean.getStep8r().equals("－")?"":bean.getStep8r()).append("|")
        .append(bean.getStep9r().equals("－")?"":bean.getStep9r()).append("|")
        .append(bean.getStep10r().equals("－")?"":bean.getStep10r()).append("|")
        .append(bean.getStep11r().equals("－")?"":bean.getStep11r()).append("|")
        .append(bean.getStep12r().equals("－")?"":bean.getStep12r()).append("|")
        .append(bean.getStep13r().equals("－")?"":bean.getStep13r()).append("|")
        .append(bean.getStep14r().equals("－")?"":bean.getStep14r()).append("|")
        .append(bean.getStep15r().equals("－")?"":bean.getStep15r()).append("|");
        ...
        if (fieldRemark)
            addCell(tabExtend, "", theFont, (color==0?Color.LIGHT_GRAY:null));
      }
      rs2.close();
    } catch (Exception ex) {
      ex.fillInStackTrace();
  ...
  public static int WS_Product_Route(Document document,
    ...
    try {
      ...
      Paragraph sec = null;
      String productType = OiMaintainService.getProductType(conn, fm.getSid());
      ...
      sql = sql + "order by product_body,mask_option,db_with_code,ws_route,ws_route_add,route_type desc,test_mode ";
      ...
      while(rs.next()){
        if (result == 0) document.add(new Paragraph(new Chunk("1-1. WS ROUTE", BasicFont)));
          result ++;
          curGroupKey = null;
    	  curGroupKey = OiMaintainService.getGroupKey(productType, rs.getString("product_body"), rs.getString("brand"), rs.getString("mask_option"),
        ...
        if (!curGroupKey.equals(preGroupKey)) {
          ...
          speedList = null;
          speedList = OiMaintainService.getSpeedList(conn, rs.getString("product_body"), rs.getString("brand"), rs.getString("version"), rs.getString("ws_route"), rs.getString("ws_route_add"), table, "ws");
          section ++;
          sec = null;
          if (speedList.equals(""))
            sec = new Paragraph(new Chunk("1-1-"+section+". Product Group Key - "+curGroupKey, BasicFont));
          else
            sec = new Paragraph(new Chunk("1-1-"+section+". Product Group Key - "+curGroupKey+" (Grade:I/C/W/Y/S, Speed:"+speedList+")", BasicFont));
          sec.setSpacingAfter(5);
          document.add(sec);
          table1 = null;
          //M200712056,20080130
          if (vendor.equals("")) {
            float[] widths = {5, 5, 5, 10, 8, 5, 11, 8, 8, 16, 15, 17};//23-->18,24-->19, add 10
            table1 = new PdfPTable(widths);
          } else {
            float[] widths = {5, 5, 5, 12, 8, 5, 16, 8, 10, 15, 26};//20-->15,33-->28, add 10
            table1 = new PdfPTable(widths);
          }
          table1.setWidthPercentage(100);
          table1.setSpacingBefore(0);
          table1.addCell(new Phrase(new Chunk("Route Type",SmallFont)));  //5
          ...
          table1.addCell(new Phrase(new Chunk("PGM Name",SmallFont)));  //10 -> 11
          table1.addCell(new Phrase(new Chunk("Temperature",SmallFont)));  //8
          table1.addCell(new Phrase(new Chunk("HW Configure",SmallFont)));  //10
          table1.addCell(new Phrase(new Chunk("PGM Special Control",SmallFont)));  //10
          table1.addCell(new Phrase(new Chunk("PGM Notes",SmallFont)));  //18 -> 16
          
          //M200712056,20080130
          if (vendor.equals(""))
            table1.addCell(new Phrase(new Chunk("Route Comment",SmallFont)));  //19 -> 17
          //table1.addCell(new Phrase(new Chunk("MCP Flag",SmallFont)));  
        ...
        if (vendor.equals("")) {
          if (rs.getString("tf_ws_comment") != null){
            table1.addCell(new Phrase(rs.getString("tf_ws_comment"), SmallFont));
          } else {
            table1.addCell(new Phrase(" ", SmallFont));
          }
        }
        
        /*if (rs.getString("mcp_flag") != null){
            table1.addCell(new Phrase(rs.getString("mcp_flag"), SmallFont));
          } else {
            table1.addCell(new Phrase(" ", SmallFont));
          }*/
        ...
        maxSite = "";
        maxSite = OiMaintainService.getMaxsite(conn, "PROD", rs.getString("pgm_id"));
        if (pr != null) {
  ...
  public static int WS_Product_Route_Mcp(Document document, Font BasicFont,
		...
		try {
			...
			// select ecrtime for e8049 dat share project, Sophia
			String ecrtime[] = OiMaintainService.getEcrEffectTime(conn, fm
					.getProductbody(), fm.getVersion(), fm.getBrand());

			while (rs.next()) {
				if (result == 0)
					document.add(new Paragraph(new Chunk("1-1. WS ROUTE", BasicFont)));
				result++;
				curGroupKey = null;
				curGroupKey = OiMaintainService.getGroupKey(productType, rs
						.getString("product_body"), rs.getString("brand"), rs
						.getString("com_mask_option"), null, null, rs
						.getString("db_with_code"), rs.getString("ws_route"),
						rs.getString("ws_route_add"), rs
								.getString("sales_form"), 0);
				if (!curGroupKey.equals(preGroupKey)) {
					if (section > 0) {
						document.add(table1);
					}
					speedList = null;
					speedList = OiMaintainService.getSpeedList(conn, rs
							.getString("product_body"), rs.getString("brand"),
							rs.getString("version"), rs.getString("ws_route"),
  ...
  // List AVI Vendors
  public static int AVI_List(Document doc,
                                  Font BasicFont,
                                  Font SmallFont,
                                  String section,
                                  String sid,
    ...
    int result = 0;
    try {
      String sql = "SELECT * FROM tf_test_parameter_pbc"+table+" where sid=? AND test_type='AVI' ";
      if (!vendor.equals(""))
        sql += " AND SITE = ?";
      PreparedStatement ps = conn.prepareStatement(sql);
      ps.setString(1,sid);
      ...
      while (rs.next()) {
        result ++;
        if (i == 0)
          doc.add(new Paragraph(new Chunk(section+". AVI Release Vendor", BasicFont)));
        if (++i > 1) vendor_list += ",";
  ...
  public static int FT_Product_Route(Document document,
    ...
    try {
      ...
      sql.append("from tf_bom_route"+table+" a, tf_route_master_ft_view b, tf_test_parameter_ft"+table+" c, ba_package_type d , tf_product_route"+table+" e ");
      ...
      while(rs.next()){
        ...
        result++;
    	curGroupKey = OiMaintainService.getGroupKey(productType, rs.getString("product_body"), rs.getString("brand"), rs.getString("backend_option"),
            rs.getString("package_code"), rs.getString("pin_count"), rs.getString("fg_with_code"), rs.getString("ft_route"), rs.getString("ft_route_add"), null, 1);
        if (!curGroupKey.equals(preGroupKey)) {
          if (subsection > 0) {
            document.add(table1);
          }
          subsection ++;
          speedList = null;
          speedList = OiMaintainService.getSpeedList(conn, rs.getString("product_body"), rs.getString("brand"), rs.getString("version"), rs.getString("ft_route"), rs.getString("ft_route_add"), table, "ft");
          sec = null;
          if (speedList.equals(""))
            sec = new Paragraph(new Chunk("1-"+section+"-"+subsection+". Product Group Key - "+curGroupKey, BasicFont));
          else
            sec = new Paragraph(new Chunk("1-"+section+"-"+subsection+". Product Group Key - "+curGroupKey+" (Grade:I/C/W/Y/S, Speed:"+speedList+")", BasicFont));
          sec.setSpacingAfter(5);
          document.add(sec);
          table1 = null;
          //M200712056,20080130
          if (vendor.equals("")) {
            float[] widths = {5, 5, 4, 4, 5, 5, 8, 7, 7, 10, 6, 5, 8, 8, 8, 7, 7, 8};//11-->9,11-->9,10-->8,10-->8add 8
            table1 = new PdfPTable(widths);
          } else {
            float[] widths = {5, 5, 4, 4, 5, 5, 8, 7, 7, 10, 8, 5, 10, 8, 8, 9, 9};//11-->10,9-->8,13-->11, 13-->11,12-->11,add 8
            table1 = new PdfPTable(widths);
          }
          table1.setWidthPercentage(100);
          table1.setSpacingBefore(0);
          table1.addCell(new Phrase(new Chunk("Route Type",SmallFont)));  //4
          table1.addCell(new Phrase(new Chunk("Route",SmallFont)));  //5
          ...
          table1.addCell(new Phrase(new Chunk("Noraml Grade Temperature",SmallFont)));  //5
/*     	  table1.addCell(new Phrase(new Chunk("C Grade",SmallFont)));  //5
          table1.addCell(new Phrase(new Chunk("W Grade",SmallFont)));  //5
          table1.addCell(new Phrase(new Chunk("Y Grade",SmallFont)));  //5
          table1.addCell(new Phrase(new Chunk("J Grade",SmallFont)));  //5
          table1.addCell(new Phrase(new Chunk("K Grade",SmallFont)));  //5
*/     	  table1.addCell(new Phrase(new Chunk("AEB Grade Temperature",SmallFont)));  //7
          ...
          table1.addCell(new Phrase(new Chunk("PGM ID",SmallFont)));  //5
          table1.addCell(new Phrase(new Chunk("Test Program Name",SmallFont)));  //8
          table1.addCell(new Phrase(new Chunk("Actual Program Name",SmallFont)));  //8
          table1.addCell(new Phrase(new Chunk("PGM Special Control",SmallFont)));  //8
          table1.addCell(new Phrase(new Chunk("HW Configure",SmallFont)));  //7
          table1.addCell(new Phrase(new Chunk("PGM Notes",SmallFont)));  //7
          
          //M200712056,20080130
          if (vendor.equals(""))
            table1.addCell(new Phrase(new Chunk("Route Comment",SmallFont)));  //8
        ...
        /*table1.addCell(new Phrase(new Chunk(i_grade_temperature,SmallFont)));*/
        /*table1.addCell(new Phrase(new Chunk(c_grade_temperature,SmallFont)));*/
        /*table1.addCell(new Phrase(new Chunk(w_grade_temperature,SmallFont)));*/
        /*table1.addCell(new Phrase(new Chunk(y_grade_temperature,SmallFont)));*/
        /*table1.addCell(new Phrase(new Chunk(j_grade_temperature,SmallFont)));*/

        
        i_grade_temperature = PDFdiffService.getTemperature(rs.getString("i_grade"));
        ...
        c_grade_temperature = PDFdiffService.getTemperature(rs.getString("c_grade"));
        ...
        w_grade_temperature = PDFdiffService.getTemperature(rs.getString("w_grade"));
        ...
        y_grade_temperature = PDFdiffService.getTemperature(rs.getString("y_grade"));
        ...
        j_grade_temperature = PDFdiffService.getTemperature(rs.getString("j_grade"));
        ...
        k_grade_temperature = PDFdiffService.getTemperature(rs.getString("k_grade"));
        ...
        l_grade_temperature = PDFdiffService.getTemperature(rs.getString("l_grade"));
        if(l_grade_temperature != null && !l_grade_temperature.equals("NA℃")&& !l_grade_temperature.equals("")) {
            l_grade_temperature = "L:"+ l_grade_temperature +"\n";
        }else {
            l_grade_temperature = "";
        }
        
        n_grade_temperature = PDFdiffService.getTemperature(rs.getString("n_grade"));
        if(n_grade_temperature != null && !n_grade_temperature.equals("NA℃")&& !n_grade_temperature.equals("")) {
            n_grade_temperature = "N:"+ n_grade_temperature +"\n";
        }else {
            n_grade_temperature = "";
        }
            
        b_grade_temperature = PDFdiffService.getTemperature(rs.getString("b_grade"));
        if(b_grade_temperature != null && !b_grade_temperature.equals("NA℃")&& !b_grade_temperature.equals("")) {
            b_grade_temperature = "B:"+ b_grade_temperature +"\n";
        }else {
            b_grade_temperature = "";
        }
        
        e_grade_temperature = PDFdiffService.getTemperature(rs.getString("e_grade"));
        if(e_grade_temperature != null && !e_grade_temperature.equals("NA℃")&& !e_grade_temperature.equals("")) {
        ...
        s_grade_temperature = PDFdiffService.getTemperatureSplit(rs.getString("s_grade"));
        table1.addCell(new Phrase(new Chunk(s_grade_temperature,SmallFont)));
        ...
        if (vendor.equals("")) {
          if (rs.getString("tf_ft_comment") != null) {
            table1.addCell(new Phrase(rs.getString("tf_ft_comment"), SmallFont));
          }
          else {
            table1.addCell(new Phrase(" ", SmallFont));
          }
        ...
        if (pr != null) { 
        	...
        	e8049share.append(((i_grade_temperature=="")?"NA℃":i_grade_temperature).replaceAll("I:", "").replaceAll("\n", "")+"|");
        	e8049share.append(((c_grade_temperature=="")?"NA℃":c_grade_temperature).replaceAll("C:", "").replaceAll("\n", "")+"|");
...
//    		e8049share.append(s_grade_temperature+"|");
    		e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs.getString("s_grade"),"S")+"|");
    		e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs.getString("s_grade"),"P")+"|");
    		e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs.getString("s_grade"),"Q")+"|");
    		e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs.getString("s_grade"),"R")+"|");
    		e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs.getString("s_grade"),"T")+"|");
    		e8049share.append(ecrtime[0]+"|");
    		e8049share.append(ecrtime[1]+"|");
            e8049share.append(((w_grade_temperature=="")?"NA℃":w_grade_temperature).replaceAll("W:", "").replaceAll("\n", "")+"|");
            e8049share.append(((y_grade_temperature=="")?"NA℃":y_grade_temperature).replaceAll("Y:", "").replaceAll("\n", "")+"|");
            e8049share.append(((j_grade_temperature=="")?"NA℃":j_grade_temperature).replaceAll("J:", "").replaceAll("\n", "")+"|");
            e8049share.append(((k_grade_temperature=="")?"NA℃":k_grade_temperature).replaceAll("K:", "").replaceAll("\n", "")+"|");
            e8049share.append(((l_grade_temperature=="")?"NA℃":l_grade_temperature).replaceAll("L:", "").replaceAll("\n", "")+"|");
            e8049share.append(((n_grade_temperature=="")?"NA℃":n_grade_temperature).replaceAll("N:", "").replaceAll("\n", "")+"|");
            e8049share.append(((b_grade_temperature=="")?"NA℃":b_grade_temperature).replaceAll("B:", "").replaceAll("\n", "")+"|");
            e8049share.append(((e_grade_temperature=="")?"NA℃":e_grade_temperature).replaceAll("E:", "").replaceAll("\n", "")+"|");
            e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs.getString("s_grade"),"U")+"|");
            e8049share.append(maxSite+"|");//MAX_SITE
            if (rs.getString("pgm_special_control") != null)
        		e8049share.append(rs.getString("pgm_special_control")+"|");
        	else 
  ...
  public static int FT_Product_Route_Mcp(Document document, Font BasicFont,
		...
		try {
			...
			sql.append("'Main' route_type,a.product_body,a.brand,a.version,a.package_type package_code,c.package_type package_name,a.pin_count,a.backend_option,a.fg_with_code, ");
			sql.append("a.ft_route,''ft_route_add,e.step_name test_mode,c.tester,c.site,c.pgm_id,c.program_name,c.i_grade,c.c_grade,c.w_grade,c.y_grade,c.j_grade,c.k_grade,c.l_grade,c.n_grade,c.b_grade,c.e_grade,c.s_grade,c.body_size,c.tf_comment,decode(a.ft_route_add,null,a.tf_comment,'') tf_ft_comment,c.actual_file, c.pgm_special_control, c.hw_configure ");
			sql.append("from tf_bom_route_mcp" + table + " a, tf_route_master_ft_view b, tf_test_parameter_ft" + table + " c, ba_package_type d , tf_product_route" + table + " e ");
			sql.append("where a.sid = ? ");
			sql.append("and trim(ft_route) is not null and ft_route != 'NA' ");
			sql.append("and a.ft_route = b.route_name ");
			sql.append("and a.sid = c.sid and a.sid = e.sid ");
			...
			while (rs.next()) {
				...
				curGroupKey = OiMaintainService.getGroupKey(productType, rs
						.getString("product_body"), rs.getString("brand"), rs
						.getString("backend_option"), rs
						.getString("package_code"), rs.getString("pin_count"),
				...
				if (!curGroupKey.equals(preGroupKey)) {
					...
					speedList = OiMaintainService.getSpeedList(conn, rs
							.getString("product_body"), rs.getString("brand"),
							rs.getString("version"), rs.getString("ft_route"),
				...
				if (pr != null) {
					...
					e8049share.append("||");
					// e8049share.append(s_grade_temperature+"|");
					e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs
							.getString("s_grade"), "S")
							+ "|");
					e8049share.append(PDFdiffService.getTemperatureAEBgrade(rs
							.getString("s_grade"), "P")
  ...
  public static boolean BasicInfo(Document doc,
                                  Font BasicFont,
                                  Font SmallFont,
                                  ProTestRouteBeanAF fm,
                                  String sid,
    ...
    try {
      ...
      String sql = "SELECT decode(options,'*',1,0) opt,decode(grade,'*',1,0) gra,a.* FROM tf_basic_info"+table+"_vw a where sid=? order by opt,gra,tester,options,grade,good_bin";
      PreparedStatement ps = conn.prepareStatement(sql);
      ps.setString(1,sid);
      ResultSet rs = ps.executeQuery();
      ...
      int i = 0;
      float[] widths = {5,5,4,4,7,7,10,24,4,5,5,12,14};//NVM, MROM
      String productType = OiMaintainService.getProductType(conn, fm.getSid());
      ...
      while (rs.next()) {
        i++;
        table5.addCell(new Phrase(new Chunk(rs.getString("tester"),SmallFont)));
        table5.addCell(new Phrase(new Chunk(rs.getString("options"),SmallFont)));
        table5.addCell(new Phrase(new Chunk(rs.getString("grade"),SmallFont)));
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ib_bin")),SmallFont)));
        table5.addCell(new Phrase(new Chunk(rs.getString("good_bin"),SmallFont)));
        table5.addCell(new Phrase(new Chunk(rs.getString("bin_type_str"),SmallFont)));
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("inkless_grade")),SmallFont)));
        table5.addCell(new Phrase(new Chunk(rs.getString("ipn_action_str"),SmallFont)));
        if (!productType.equals("XROM")){
        	table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ktd_bin_flag")),SmallFont)));
	        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("epn_speed")),SmallFont)));
	        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("test_speed")),SmallFont)));
        }
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("down_grade")),SmallFont)));
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("remark")),SmallFont)));
        ...
        if (pr != null) {
           ...
           e8049share.append(StringUtil.formatNull(rs.getString("epn_speed"))+"|");
    	   e8049share.append(StringUtil.formatNull(rs.getString("test_speed"))+"|");
    	   e8049share.append(StringUtil.formatNull(rs.getString("down_grade"))+"|");
    	   e8049share.append(StringUtil.formatNull(rs.getString("remark"))+"|");
    	   e8049share.append(StringUtil.formatNull(rs.getString("inkless_grade"))+"|");
    	   e8049share.append(ecrtime[0]+"|");
   		   e8049share.append(ecrtime[1]+"|");
   		   //e8049share.append(StringUtil.formatNull(rs.getString("ktd_bin_flag"))+"|");  2020-4-20  外包廠用不到, 所以建議E-File 不新增 phoebe,km
    	   pr.println(e8049share.toString());
    	   e8049share.delete(0, e8049share.length());
        }   
      ...
      ps = null;
      String comments =
          com.mxic.oiplus.oimaintain.TFIMBasicService.getBAComment(conn, Integer.parseInt(sid),
        		  (table.equals("")?"R":"P"));
  ...
  public static boolean Yield(Document doc,
	  ...
	  try {
    	  ...
    	  PdfPTable table5 = null;
            ...
            if (table.equals("") && fm.getVendor() != null && !fm.getVendor().equals("") && !fm.getVendor().equals("TEST1")) {
    	  ...
    	  for (int facility = 0; facility < 2; facility ++) {
    		  ...
    		  for (int nvm_ws = 0,other = 0; nvm_ws < 2 ; nvm_ws ++,other ++) {
                    ...
                    if (facility == 0 && product_type.equals("NVM") && nvm_ws == 1) { // 假如為WS且為NVM，Dgrade Criteria 只要取消一個CHANGE_IPN欄位即可
                        widths = new float[9];
                        widths[0] = 5;
                        widths[1] = 4;
                        widths[2] = 4;
                    ...
                    else if (facility == 1 && product_type.equals("NVM")) { // FT需要三個欄位都取消，並加上一個DGRADE ACTION
                        widths = new float[7];
                        widths[0] = 5;
                        widths[1] = 4;
                        widths[2] = 4;
                        ...
                        widths[5] = 12;
                        widths[6] = 26;
                    }else if (/*facility == 1  || */(facility == 0 && product_type.equals("NVM") && nvm_ws == 0)) { //ws/nvm/hold的時候，需要三個欄位都取消
                        widths = new float[6];
                        widths[0] = 5;
                        widths[1] = 4;
                        widths[2] = 4;
    			  ...
    			  if(product_type.equals("NVM")) {
    			      if(facility != 0) {
    			          nvm_ws = 1;  //if facility is not ws && not NVM, run one time
    			  }	  
    			  } 
    			  
	    		  if (facility == 0 && product_type.equals("NVM") && nvm_ws == 0 ){
		    	    ydb = com.mxic.oiplus.oimaintain.YieldDefService.RetrieveYieldNVMWSHoldCriteriaPDF(""+fm.getSid(), conn, table, (facility==0?"WS":"FT"), product_type,"Hold");
		    	    hold_dgrade = "Hold Criteria";
	    		  }else if (facility == 0 && product_type.equals("NVM") && nvm_ws == 1 ){  
		    	    ydb = com.mxic.oiplus.oimaintain.YieldDefService.RetrieveYieldNVMWSHoldCriteriaPDF(""+fm.getSid(), conn, table, (facility==0?"WS":"FT"), product_type,"Dgrade");
		    	    hold_dgrade = "Dgrade Criteria";
	    		  }else{
	    		    if(!product_type.equals("NVM")) {
	    		        if(other == 0) {
	    		            ydb = com.mxic.oiplus.oimaintain.YieldDefService.RetrieveYield(""+fm.getSid(), conn, table, (facility==0?"WS":"FT"), product_type,"hcs",false);
	    		            hold_dgrade = "Hold Criteria";
	    		        } else if(other == 1) {
	    		            ydb = com.mxic.oiplus.oimaintain.YieldDefService.RetrieveYield(""+fm.getSid(), conn, table, (facility==0?"WS":"FT"), product_type,"acs",false);
	    		            hold_dgrade = "Action Criteria";
	    		        } else {
	    		            ydb = com.mxic.oiplus.oimaintain.YieldDefService.RetrieveYield(""+fm.getSid(), conn, table, (facility==0?"WS":"FT"), product_type, false);
	    		        }
	    		    } else {
	    			ydb = com.mxic.oiplus.oimaintain.YieldDefService.RetrieveYield(""+fm.getSid(), conn, table, (facility==0?"WS":"FT"), product_type, false);  
	    		  }
		    	  ...
		    	  if (ydb != null) {
		    		  for (int i = 0; i< ydb.length; i++) {
		    			  if (i==0) {
                                doc.add(new Paragraph(section + "-" + (++subsection) + " " + (facility == 0 ? "WS" : "FT") + " " + hold_dgrade + " " + "Yield" + (facility == 0 &&product_type.equals("NVM")&&other == 1 ? " (Dgrade IPN 內容依 MXIC 發送之 Dgrade table 執行)" : "") , BasicFont));
                                if(facility == 0 && product_type.equals("NVM") && nvm_ws == 1){
                                	doc.add(new Paragraph("Action Priority", RedSmallFont8));
                                	doc.add(new Paragraph("Priority 1: Dgrade , Priority 2: Change IPN", RedSmallFont8)); 
                                }
                              table5 = null;
		    				  table5 = new PdfPTable(widths);
		    				  table5.setWidthPercentage(100);
		    				  ...
		    				  table5.addCell(new Phrase(new Chunk("Product Code",SmallFont)));
                                if (facility == 0 && product_type.equals("NVM"))
                                    table5.addCell(new Phrase(new Chunk("Prod Level", SmallFont)));
                                else
		    				  table5.addCell(new Phrase(new Chunk("Brand",SmallFont)));
		    				  table5.addCell(new Phrase(new Chunk("Test Mode",SmallFont)));
		    				  if (facility == 0)
		    					  table5.addCell(new Phrase(new Chunk("Criteria (By Wafer)",SmallFont)));
		    				  else
		    					  table5.addCell(new Phrase(new Chunk("Criteria",SmallFont)));
		    				  if(!product_type.equals("NVM") && other == 1)
		    				      table5.addCell(new Phrase(new Chunk("Extra Action",SmallFont)));
		    				  else
		    				  table5.addCell(new Phrase(new Chunk("Action",SmallFont)));
                                
		    				  
								if (product_type.equals("NVM")) {
									if (facility == 0) {
										if (nvm_ws == 1) {
											table5.addCell(new Phrase(new Chunk("By Lot Downgrade", SmallFont)));
											table5.addCell(new Phrase(new Chunk("Route Name", SmallFont)));
											table5.addCell(new Phrase(new Chunk("Start Step", SmallFont)));
										}
									}
									if (facility == 1) {
										table5.addCell(new Phrase(new Chunk("DGrade Action", SmallFont)));
									}
								} else if (product_type.equals("XROM")) {
									table5.addCell(new Phrase(new Chunk("Change IPN", SmallFont)));
									table5.addCell(new Phrase(new Chunk("Route Name", SmallFont)));
									table5.addCell(new Phrase(new Chunk("Start Step", SmallFont)));
                                ...
                                /*if ((facility == 0 && product_type.equals("NVM")) || facility == 1) { //
                                    // nothing;
                                } else {
		    				  table5.addCell(new Phrase(new Chunk("Change IPN",SmallFont)));
                                }
                                if (facility == 1 && product_type.equals("NVM")) {//FT / NVM
                                        table5.addCell(new Phrase(new Chunk("DGrade Action", SmallFont)));
                                }else if(facility ==0) {//WS
                                	if(product_type.equals("NVM")){
                                ...
                                /*if (facility == 1 || (facility == 0 && product_type.equals("NVM") && nvm_ws==0)) {
                                    if(facility == 1) 
                                        table5.addCell(new Phrase(new Chunk("DGrade Action", SmallFont)));
                                } else {
                                        table5.addCell(new Phrase(new Chunk("By Lot Downgrade", SmallFont)));
		    			  ...
		    			  table5.addCell(new Phrase(new Chunk(ydb[i].getProduct_code(),SmallFont)));
		    			  table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getBrands()),SmallFont)));
		    			  table5.addCell(new Phrase(new Chunk(ydb[i].getTest_mode(),SmallFont)));
		    			  table5.addCell(new Phrase(new Chunk(ydb[i].getFull_items(),SmallFont)));
		    			  table5.addCell(new Phrase(new Chunk(ydb[i].getAction(),SmallFont)));
		    			  
							if (product_type.equals("NVM")) {
								if (facility == 0) {
									if (nvm_ws == 1) {
										table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getBy_lot_dg()), SmallFont)));
										table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getRoute_name()), SmallFont)));
										table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getStart_step()), SmallFont)));
									}
								}
								if (facility == 1) {
									table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getDg_action()), SmallFont)));
								}
							} else if (product_type.equals("XROM")) {
								table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getChange_ipn()), SmallFont)));
								table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getRoute_name()), SmallFont)));
								table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getStart_step()), SmallFont)));
							} else if (product_type.equals("MROM")) {
								table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getChange_ipn()), SmallFont)));
		    			  ...
		    			  table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(ydb[i].getRemark()),SmallFont)));
		    			  ...
		    			  /*JA201400042 E-FILE 增加*/
		                    ...
		                    if(product_type.equals("NVM") && facility ==0){
		                        e8049share.append(StringUtil.formatNull(ydb[i].getBrands())+"|");
		                        e8049share.append("|");
		                    }else{
		                        e8049share.append("|");
		                        e8049share.append(StringUtil.formatNull(ydb[i].getBrands())+"|");
		                    }
		                    e8049share.append(StringUtil.formatNull(ydb[i].getTest_mode())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getLower_limit())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getFlag1())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getFull_items())+"|");//20181214-getItem()
		                    e8049share.append(StringUtil.formatNull(ydb[i].getFlag2())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getUpper_limit())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getAction())+"|");
		                    if(product_type.equals("NVM") && facility ==0){
		                        e8049share.append(StringUtil.formatNull(ydb[i].getBy_lot_dg())+"|");
		                        e8049share.append(StringUtil.formatNull(ydb[i].getDgrade_special_ipn())+"|");
		                    }else{
		                        e8049share.append("|");
		                        e8049share.append("|");
		    		  }
		                    if(facility == 0){
		                        ...
		                        e8049share.append(StringUtil.formatNull(ydb[i].getDg_action())+"|");
		                    }
		                    e8049share.append(StringUtil.formatNull(ydb[i].getChange_ipn())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getRoute_name())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getStart_step())+"|");
		                    e8049share.append(StringUtil.formatNull(ydb[i].getRemark())+"|");
	    ...
	    try {
	      sql = "SELECT * FROM tf_yield"+table+" where sid=? order by seq";
	      ps = conn.prepareStatement(sql);
	      ps.setString(1,""+fm.getSid());
	      rs = ps.executeQuery();
	      ...
	      while (rs.next()) {
	        if (++line_no==1) {
	          if (subsection != 0)
	        	  doc.add(new Paragraph(section+"-"+(++subsection)+" Yield Table",BasicFont));
      ...
      while (rs.next()) {
        doc.newPage();
        doc.add(new Paragraph(section+"-"+(++subsection)+" "+rs.getString("doc_name"),BasicFont));
...
//output yield definition chart
    public static boolean ProdWaferlevel(Document doc, Font BasicFont, Font SmallFont, String section, String Path,ProTestRouteBeanAF fm, String table,
            Connection conn,String textFilename) {
        ...
        try {
            ...
            //doc.add(new Paragraph(section+". PRODUCT PROD LEVEL DEFINITION"));
            BaseFont bfChinese = BaseFont.createFont("MHei-Medium", "UniCNS-UCS2-H", BaseFont.NOT_EMBEDDED);
            Font RedSmallFont1 = new Font(bfChinese, 12);
            RedSmallFont1.setColor(0xEE,0,0);
          
            com.lowagie.text.Paragraph p = new Paragraph(section+". PRODUCT PROD LEVEL DEFINITION");
            p.add(new Paragraph("[同階不可執行Dgrade.]",RedSmallFont1));
            doc.add(p);

            Font redSmallFont10 = new Font(bfChinese, 10);
            redSmallFont10.setColor(0xEE,0,0);            
            doc.add(new Paragraph("Action Priority", redSmallFont10));
            doc.add(new Paragraph("Priority 1: Dgrade, Priority 2: Change IPN ", redSmallFont10));            
            
            float[] widths = {50,50};
            float[] widths2 = {50};
            PdfPTable table5 = null;

            ProWaferlevelBean[] pwb = com.mxic.oiplus.oimaintain.OiMaintainService.GetWaferlevelByCheckedFlag(conn, ""+fm.getSid(), table);
            ...
            if (table.equals("") && fm.getVendor() != null && !fm.getVendor().equals("") && !fm.getVendor().equals("TEST1")) {
              os = new FileOutputStream(textFilename+"-Prod.txt");
              pr = new PrintWriter(os);
            }
            ...
            if (pwb != null) {
            	for (int i = 0; i< pwb.length; i++) {
            		if (i==0) {
            			Paragraph par = new Paragraph(new Chunk(section+"-1. Priority 1: Dgrade", BasicFont));
            			...
            			table5.setSpacingBefore(5);
            			table5.addCell(new Phrase(new Chunk("Prod Level",SmallFont)));
            			table5.addCell(new Phrase(new Chunk("Priority",SmallFont)));
            		}
            		table5.addCell(new Phrase(new Chunk(pwb[i].getWafer_level(),SmallFont)));
            		table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(pwb[i].getRownum()),SmallFont)));
	    			  
            		e8049share.append(heading);
                    e8049share.append(StringUtil.formatNull(pwb[i].getWafer_level())+"|");
                    e8049share.append(StringUtil.formatNull(pwb[i].getBrand())+"|");
                    e8049share.append(StringUtil.formatNull(pwb[i].getBiztype())+"|");
                    e8049share.append(StringUtil.formatNull(pwb[i].getWafer_grade())+"|");
                    e8049share.append(StringUtil.formatNull(pwb[i].getApply_type())+"|");
                    e8049share.append(StringUtil.formatNull(pwb[i].getOri_priority())+"|");
            ...
            //start Change IPN Priority
            TfChangeIpnLevelBean[] cilb = TfChangeIpnLevelDao.getList();
            if (cilb != null) {
            	for (int i = 0; i< cilb.length; i++) {
            		if (i==0) {
            			Font redSmallFont8 = new Font(bfChinese, 8);
            	        redSmallFont8.setColor(0xEE,0,0); 
            			Paragraph par = new Paragraph(new Chunk(section+"-2. Priority 2: Change IPN", BasicFont));
            			par.setSpacingAfter(5);
            			doc.add(par);
                        doc.add(new Paragraph("優先順序: Chagne IPN4 優先 Change IPN3 優先 Change IPN2 優先 Change IPN", redSmallFont8));            
            			table5 = null;
            			table5 = new PdfPTable(widths2);
            			table5.setWidthPercentage(100);
            			table5.setSpacingBefore(5);
            		...
            		table5.addCell(new Phrase(new Chunk(cilb[i].getLevel_name(),SmallFont)));
            		//table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(cilb[i].getPriority()),SmallFont)));
	    			  
            		e8049share.append(heading);
                    e8049share.append(StringUtil.formatNull(cilb[i].getLevel_name())+"|");
                    //e8049share.append(StringUtil.formatNull(cilb[i].getPriority())+"|");
...
//    Font BasicFont = new Font(Font.HELVETICA, 8, Font.NORMAL, Color.BLACK);
  ...
  public static boolean BOM_Table(Document doc,
    ...
    try {
      ...
      String sql = "SELECT a.*,tf_check_step('AVI',ws_route) avi,DECODE(tf_check_step('INK',WS_ROUTE),'Y','Y',tf_check_step('INK_MAP',WS_ROUTE)) ink  FROM tf_bom_route"+table+" a where sid=? and tag != 2 "+
      ...
      if(brand.equals("MX"))
    	  widths = new float[]{4,4,4,4,4,8,8,8,8,4,14,6,10,4,4,4,4,8,10,4,14,4,4};
      else
    	  widths = new float[]{4,4,4,4,4,8,8,8,8,4,14,4,4,4,4,8,10,4,14,4,4};
      PdfPTable table5 = null;
      table5 = new PdfPTable(widths);
      table5.setWidthPercentage(100);
      table5.setSpacingBefore(5);
      ...
      table5.addCell(new Phrase(new Chunk("FT Special Control",BasicFont)));//4
      table5.addCell(new Phrase(new Chunk("FT Comment",BasicFont)));//14
      if(brand.equals("MX")){
    	  table5.addCell(new Phrase(new Chunk("Quality Level",BasicFont)));//6
    	  table5.addCell(new Phrase(new Chunk("Quality Level Comment",BasicFont)));//10
      }	  
      ...
      table5.addCell(new Phrase(new Chunk("WS Special Control",BasicFont)));//4
      ...
      while (rs.next()) {
        ...
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("backend_option")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("fg_with_code")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(rs.getString("pin_count"),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("package_type")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_code")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route")),BasicFont)));//8
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_add")),BasicFont)));//8
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_add2")),BasicFont)));//8
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_add3")),BasicFont)));//8
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("endurance")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("tf_comment")),BasicFont)));//14
        if(rs.getString("brand").equals("MX")){
        	table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("quality_level")),BasicFont)));//6
        	table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("quality_level_comment")),BasicFont)));//10
        }	
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("mcp_flag")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(rs.getString("mask_option"),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(rs.getString("db_with_code"),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(rs.getString("sort_route_code"),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(rs.getString("ws_route"),BasicFont)));//8
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ws_route_add")),BasicFont)));//10
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("wsspecialcontrol")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("tf_ws_comment")),BasicFont)));//14
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("avi")),BasicFont)));//4
        table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ink")),BasicFont)));//4
  ...
  public static boolean BOM_Mcp_Table(Document doc, Font BasicFont,
		...
		try {
			...
			String sql = "SELECT a.*,tf_check_step('AVI',ws_route) avi,DECODE(tf_check_step('INK',WS_ROUTE),'Y','Y',tf_check_step('INK_MAP',WS_ROUTE)) ink, \n" 
					...
					+ "FROM tf_bom_route_mcp"	+ table	+ " a where sid=? and tag != 2 "
			...
			float[] widths = null;
			if(brand.equals("MX"))
				widths = new float[]{ 4, 4, 4, 4, 4, 8, 8, 8, 8, 4, 14, 6, 10, 5, 7, 5, 5, 4, 4, 8,
					10, 4, 14, 4, 4 };
			else
				widths = new float[]{ 4, 4, 4, 4, 4, 8, 8, 8, 8, 4, 14, 5, 7, 5, 5, 4, 4, 8,
					10, 4, 14, 4, 4 };
			PdfPTable table5 = null;
			table5 = new PdfPTable(widths);
			table5.setWidthPercentage(100);
			...
			while (rs.next()) {
				 ...
				 * table5.addCell(new Phrase(new Chunk("",BasicFont)));
				 */
				table5.addCell(new Phrase(new Chunk(rs.getString("backend_option"), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(rs.getString("fg_with_code"), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(rs.getString("pin_count"),BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(rs.getString("package_type"), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(rs.getString("ft_route_code"), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(rs.getString("ft_route"),BasicFont)));// 8
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_add")), BasicFont)));// 8
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_add2")), BasicFont)));// 8
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ft_route_add3")), BasicFont)));// 8
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("endurance")), BasicFont)));// 4
				...
				//table5.addCell(new Phrase(new Chunk(rs.getString("mask_option"), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(rs.getString("component_no"), BasicFont)));// 5
				table5.addCell(new Phrase(new Chunk(rs.getString("com_prod_body"), BasicFont)));// 5
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("com_mask_option")), BasicFont)));// 5
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("com_backend_option")), BasicFont)));// 5
				table5.addCell(new Phrase(new Chunk(rs.getString("db_with_code"), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("sort_route_code")), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ws_route")),BasicFont)));// 8
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("ws_route_add")), BasicFont)));// 10
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("wsspecialcontrol")), BasicFont)));// 4
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("tf_ws_comment")), BasicFont)));// 14
				table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("avi")), BasicFont)));// 4
  ...
  public static boolean WipControl(Document doc,
                                   String productbody,
                                  Font BasicFont,
                                  String section,
                                  String sid,
...
//      return true;
    ...
    try {
      ...
      table5.setWidthPercentage(100);
      table5.setSpacingBefore(5);
      table5.addCell(new Phrase(new Chunk("Tested 1st PG Name",BasicFont)));
      table5.addCell(new Phrase(new Chunk("Tested 2nd PG Name",BasicFont)));
      table5.addCell(new Phrase(new Chunk("Tested 3rd PG Name",BasicFont)));
      table5.addCell(new Phrase(new Chunk("Tested 4th PG Name",BasicFont)));
      table5.addCell(new Phrase(new Chunk("Tested 5th PG Name",BasicFont)));
      ...
      while (rs.next()) {
        if (i == 0) {
          ...
          if (rs.getString("optionlist") != null) {
        	  String options[] = rs.getString("optionlist").split(",");
        	  int j = 0;
          ...
          data.append(StringUtil.Utf8ToBig5_new(TDSResource.getProperties("TIMPdf").getValue("ctrl"+rs.getString("ctrl_type"))));
        ...
        if (rs.getString("ctrl_type").equals("3-1")) {
            table5.addCell(new Phrase(new Chunk(rs.getString("pgname1"), BasicFont)));
            table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("pgname2")), BasicFont)));
            table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("pgname3")), BasicFont)));
            table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("pgname4")), BasicFont)));
            table5.addCell(new Phrase(new Chunk(StringUtil.NullConvert(rs.getString("pgname5")), BasicFont)));
        }
      }
  ...
  public static String getFileName(Connection conn, String productBody, String brand, String version, String vendor, boolean diffFlag, String tx) {
...
//      if (vendor.equals("MX01")) { oiname = "8046"; vendor = ""; }
	  ...
	  if (brand.equals("KH"))
		  fileName = oiname + "k-" + productBody + vendor + diff + "v" + version + tx;
	  else
