...
public class OiMaintainStep {
  ...
  private String tf_cp_test_step;
  ...
  private String tf_yield_definition;	// old yield definition
  ...
  public String getV_tf_prod_waferlevel(){
	    if (tf_prod_waferlevel.equals("Y")){
	      return "(V)";
	    } else if(tf_prod_waferlevel.equals("N")){
	      return " ";
	    } else{
	      return null;
	    }
...
public String getTf_cp_test_step() {
    return tf_cp_test_step;
}

public void setTf_cp_test_step(String tf_cp_test_step) {
    this.tf_cp_test_step = tf_cp_test_step;
}

public String getV_tf_cp_test_step(){
    if (tf_cp_test_step.equals("Y")){
      return "(V)";
    } else if(tf_cp_test_step.equals("N")){
      return " ";
    } else{
      return null;
    }
