...
*/
    try {
		httpServletResponse.sendRedirect(httpServletResponse.encodeRedirectURL(Request.getContextPath() + "/OImaintain/goPDFPageAction.do?sid="+fm.getSid()+"&productbody="+fm.getProductbody()+"&brand="+fm.getBrand()+"&version="+fm.getVersion()+"&package_component="+fm.getPackage_component()));
	} catch (IOException e) {
