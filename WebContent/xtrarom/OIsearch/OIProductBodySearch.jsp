<!-- /xtrarom/OIsearch/OIProductBodySearch.jsp -->
...
function table_search(sid,product,version,status){
 	...
 	document.forms[0].listControl.value = 'table_search';
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bg1" align="center">
			...
			<div id="myDIV1" align="center" valign="top" style="boder:0;height:500;overflow:scroll" >
						<table width="95%" cellspacing="1" cellpadding="0" align="center" class="table2">
								<tr class="title1">
									<td height="20" align="left" width="171">Product Body
									</td>
									<td height="20" align="left" width="135">Version
	              					</td>
	              					<td height="20" align="left" width="111">Status
	              					</td>
	              					<td height="20" align="left" width="107">Creator
	              					</td>
	              					<td height="20" align="left" >Last Modified Date　
	              					</td>
                                                        <td height="20" align="left" >Route Chart Change　
	              					</td>
								</tr>
				<logic:present name="list" >
		  		<logic:iterate id="tmp" name="list" >
		  						<tr class="list1">
									<td align="left" height="20" width="171" class="box9a" onclick="table_search('<bean:write name="tmp" property="sid"/>','<bean:write name="tmp" property="product_body"/>','<bean:write name="tmp" property="version"/>','<bean:write name="tmp" property="status"/>')">
									<bean:write name="tmp" property="product_body"/>
									</td>
									<td align="left" height="20" width="135"><bean:write name="tmp" property="version"/>
									</td>
									<td align="left" height="20" width="111"><bean:write name="tmp" property="status"/>
									</td>
									<td align="left" height="20" width="107"><bean:write name="tmp" property="creator"/>
									</td>
									<td align="left" height="20" width="223"><bean:write name="tmp" property="log_time"/>
									</td>
                                                                        <td align="left" height="20" width="223"><bean:write name="tmp" property="route_change"/>
									</td>
								</tr>
							</td>
				  </logic:iterate>
