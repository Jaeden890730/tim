<!-- /xtrarom/OIsearch/OIYieldDefinition.jsp -->
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<b>
						<font size="4">TIM</font><font size="2">　OI Query - Yield Definition</font>
						</td>
					</tr>
					<tr>
						<td height="20">
				...
				<table id="myTable1" width="95%" cellspacing="1" cellpadding="0" align="center" class="table2">
						<tr class="list1">
							<td height="4" align="left" colspan="13"><font size="2"><b>Product: <bean:write name="oiQueryStepAForm" property="product_body"/> / <bean:write name="oiQueryStepAForm" property="brand"/> / Version <bean:write name="oiQueryStepAForm" property="version"/>　</b></font></td>
						</tr>
				...
				<logic:iterate id="tmp1" name="list1" >
					<tr class="list1">
                                          <td height="20" align="left">Yield Definition</td>
