<!-- /xtrarom/OIsearch/OIFTTestParameterInformation.jsp -->
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<b>
						<font size="4">TIM</font><font size="2">　OI Query - FT Test Parameter Information</font>
						</td>
					</tr>
					<tr>
						<td height="20">
				...
				<table width="95%" cellspacing="1" cellpadding="0" align="center" class="table2">
				<tr class="list1">
							<td height="15" align="left" colspan="16"><font size="2"><b>Product: <bean:write name="oiQueryStepAForm" property="product_body"/> / <bean:write name="oiQueryStepAForm" property="brand"/> / Version <bean:write name="oiQueryStepAForm" property="version"/>　</b></font></td>
				</tr>
				</table>
				...
				<thead>
						...
						<tr class="list1">
							...
							<td height="15" align="center" class="title1" rowspan="2">PGM Special Control</td>
							<td height="15" align="center" class="title1" rowspan="2">One Main PGM Group Version</td>
