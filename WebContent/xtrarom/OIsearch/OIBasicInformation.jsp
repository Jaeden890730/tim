<!-- /xtrarom/OIsearch/OIBasicInformation.jsp -->
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<b>
						<font size="4">TIM</font><font size="2">　OI Query - Basic Information</font>
						</td>
					</tr>
					<tr>
						<td height="20">
				...
				<table id="myTable1" width="95%" cellspacing="1" cellpadding="0" align="center" class="table2">
						<tr class="list1">
							<td height="5" align="left" colspan="13"><font size="2"><b>Product: <bean:write name="oiQueryStepAForm" property="product_body"/> / <bean:write name="oiQueryStepAForm" property="brand"/> / Version <bean:write name="oiQueryStepAForm" property="version"/>　</b></font></td>
						</tr>

						<tr class="list1">
							<td height="15" align="center" class="title1" >Test Mode</td>

							<td height="15" align="center" class="title1" >Good Bin</td>
							<td height="15" align="center" class="title1" >Fail Bin</td>
							<td height="15" align="center" class="title1" >Remark</td>
						</tr>

				<logic:present name="list1" >
				<logic:iterate id="tmp1" name="list1" >
					<tr class="list1">
						<td height="20" align="left"> <bean:write name="tmp1" property="tester"/></td>
						<td height="20" align="left"> <bean:write name="tmp1" property="good_bin"/></td>
						<td height="20" align="left"> <bean:write name="tmp1" property="fail_bin"/></td>
						<td height="20" align="left"> <bean:write name="tmp1" property="remark"/></td>
