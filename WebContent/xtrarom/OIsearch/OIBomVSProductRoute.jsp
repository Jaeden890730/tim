<!-- /xtrarom/OIsearch/OIBomVSProductRoute.jsp -->
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<b>
						<font size="4">TIM</font><font size="2">　OI Query - Bom VS Product Route - Normal Production</font></td>
					</tr>
					<tr>
						<td height="20">
				...
				<thead>
						...
						<tr class="list1">
							...
							<td height="20" align="left" class="title1">FT Route Code</td>
							<td height="20" align="left" class="title1">FT Route</td>
							<td height="20" align="left" class="title1">FT Add Route1</td>
							<td height="20" align="left" class="title1">FT Add Route2</td>
							<td height="20" align="left" class="title1">FT Add Route3</td>
							<td height="20" align="left" class="title1">FT Add Route4</td>
							<td height="20" align="left" class="title1">FT Add Route5</td>
							<td height="20" align="left" class="title1">FT Add Route6</td>
							<td height="20" align="left" class="title1">Route Cat.</td>
							<td height="20" align="left" class="title1">FT Comment</td>
                            <td height="20" align="left" class="title1">Sort Route Code</td>
							<td height="20" align="left" class="title1">WS Route</td>
							<td height="20" align="left" class="title1">WS Add. Route1</td>
							<td height="20" align="left" class="title1">WS Add. Route2</td>
							<td height="20" align="left" class="title1">WS Add. Route3</td>
							<td height="20" align="left" class="title1">WS Add. Route4</td>
							<td height="20" align="left" class="title1">WS Add. Route5</td>
							<td height="20" align="left" class="title1">WS Comment</td>
						</tr>
				</thead>
			    <tbody>			
				...
				<logic:iterate id="tmp1" name="list1" >
					<tr class="list1">
						...
						<td height="20" align="center"> <bean:write name="tmp1" property="ft_route_code"/></td>
						...
						<td height="20" align="center"> <bean:write name="tmp1" property="ftAddroute1"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ftAddroute2"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ftAddroute3"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ftAddroute4"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ftAddroute5"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="route_cat"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ft_comment"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="sort_route_code"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_route"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_route_add"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_route_add1"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_route_add2"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_route_add3"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_route_add4"/></td>
						<td height="20" align="center"> <bean:write name="tmp1" property="ws_comment"/></td>
					</tr>
				</logic:iterate>
				</logic:present>
				</tbody>
