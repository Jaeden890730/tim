<!-- /xtrarom/OImaintain/DuplicateRowRe.jsp -->
...
<%
BomProductReRouteBean[] bm = (BomProductReRouteBean[]) request.getAttribute("DupRow");
String pro_b=null;
String brand=null;
...
ProTestReRouteBean[] Bodyver=OiMaintainService.BodyversionRe(pro_b);//lai-add-20070522
ProTestReRouteBean[] Maskoptrev=OiMaintainService.MaskoptionrevRe(pro_b);//lai-add-20070522
...
<html:html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=big5">
      ...
      function redirectToBomReRoute(tmpform){
    	var tmp1=tmpform.sid.value;
        window.location="<html:rewrite page='/OImaintain/bomProductReRouteActionX.do?sid="+tmp1+"'/>";
      }
      </script>
    </head>
              ...
              <br>
                <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td width="15%" height="25" class="title2">
                      ...
                      <td noWrap height="25" width="85%" class="title4"><font size="4">TIM BOM VS Product Route - Recycle Test Maintenance / Duplicate Row</font></td>
                    </tr>
                    <tr>
                    ...
                    <html:form  action="/OImaintain/insertBomDupReActionX.do">
                      ...
                      <div id="myDIV1" align="center" style="border:0;" >
                        <table width="95%" border="0" id="table28">
                          <tr>
                            <td>
                              <input type="submit" name="dup1" value="Duplicate"/>
                              <input type="button" name="bak1" value="Cancel" onclick="redirectToBomReRoute(this.form);"/>
                            </td>
                          </tr>
                        </table>
                        <table id="table27" cellspacing=1 cellpadding=0 class=table2  >
                          <thead>
                            <tr class="list1">
                              <td colspan="16" align="left"><font size="2"><b>Product: <bean:write name="proTestReRouteBeanAFX" property="productbody"/> / Version <bean:write name="proTestReRouteBeanAFX" property="version"/> </b></font></td>
                            </tr>
                        ...
                        <tbody>
                          ...
                          <tr class="list1">
                            ...
                            <td align="left"><input type="hidden" name="recycle_code" value="<bean:write name="result" property="recycle_code"/>"/><bean:write name="result" property="recycle_code"/></td>
				...
				<select name="ftroute" size="1">
                      ...
                      <table width="95%" border="0" id="table28">
                        <tr>
                          <td>
                            <input type="submit" name="dup2"  value="Duplicate" />
                            <input type="button" name="bak2" value="Cancel" onclick="redirectToBomReRoute(this.form);"/>
                          </td>
                        </tr>
                      </table>
                    </div>
