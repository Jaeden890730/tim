<!-- /xtrarom/OImaintain/MakePDF.jsp -->
...
//         alert("TEST: " + s.selectedIndex);
        ...
        ref.onclick=function() {
      	    var fileName = '8049<%=brand%>-<bean:write name="proTestRouteBeanAF" property="productbody"/>' + vdr + 'v<bean:write name="proTestRouteBeanAF" property="version"/>.pdf';
  ...
  <tr>
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
            ...
            <td noWrap height="25" width="85%" class="title4"><font size="4">Producing PDF Files</font>
            </td>
          </tr>
          <tr>
   ...
   <input type="hidden" name="package_component" value="<%=fm.getPackage_component()%>"/>
        <div id="myDIV1" align="center" style="border:0;" >
          <table width="95%" border="0" id="table28">
            <tr>
              <td>
                <input type="button" name="pdf1" value="製作廠內PDF" onclick="redirectPDF(this.form);" class="button1" />
                  [<a href="#" onclick="commonDownloadFile('${pageContext.request.contextPath}', 'TIMPdf', 'pdf_dl.dir', '8049<%=brand%>-<bean:write name="proTestRouteBeanAF" property="productbody"/>v<bean:write name="proTestRouteBeanAF" property="version"/>.pdf')">廠內 OI </a>]
                  [<a href="#" onclick="commonDownloadFile('${pageContext.request.contextPath}', 'TIMPdf', 'pdf_dl.dir', '8049<%=brand%>-<bean:write name="proTestRouteBeanAF" property="productbody"/>cv<bean:write name="proTestRouteBeanAF" property="version"/>.pdf')">廠內 Cover Page</a>]
                <br><br>
		        <input type="button" name="pdf2" value="製作各廠PDF" onclick= "redirectVendorPDF(this.form);" class="button1" />
                <select name="vendorname" onchange="changeVendor(this);">
                  ...
                  [<a id="vendorOI" href="#" onclick="commonDownloadFile('${pageContext.request.contextPath}', 'TIMPdf', 'pdf_dl.dir', '8049<%=brand%>-<bean:write name="proTestRouteBeanAF" property="productbody"/><%=vendor%>v<bean:write name="proTestRouteBeanAF" property="version"/>.pdf')">各廠 OI</a>]
                <br><br>
