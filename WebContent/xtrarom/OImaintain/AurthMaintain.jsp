<!-- /xtrarom/OImaintain/AurthMaintain.jsp -->
...
AurthMaintainActionForm[] rs = AurthMaintainService.getInfo(sid);
	      ...
	      <td width="100%" height="490" valign="top"><br>
	          ...
	          <tr>
                ...
                <logic:present name="list1">
                  ...
                  <form name="form1" action="<html:rewrite page="/OImaintain/aurthMaintainActionX.do"/>?sid=<%=sid%>">
                    <input name="listControl" type="hidden" value = "update_data">
...
<% } %>
 <input type="button" name="Cancel Update" value="回維護主畫面" class="button1" onclick="back('<%=sid%>');">
                  </td>
                </tr>
              </table>
