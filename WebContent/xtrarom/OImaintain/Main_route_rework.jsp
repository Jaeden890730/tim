<!-- /xtrarom/OImaintain/Main_route_rework.jsp -->
...
String sid = Integer.toString(((MainRouteReForm) request.getAttribute("MainRouteReFormX")).getSid());
...
<title>Main Route vs Rework Route Information</title>
...
function add(sid,pd_body,version,route_type){
	window.location="<html:rewrite page="/xtrarom/OImaintain/MainRouteAdd_Rework.jsp"/>?sid=" +sid +"&pd_body=" + pd_body +"&version="+ version +"&route_type="+ route_type;
}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bg1" align="center">
          <tr>
            <td width="100%" height="490" valign="top">
              <br>
              <form name="form1" method="post" action="<html:rewrite page="/OImaintain/saveMainRouteReActionX.do"/>">
              ...
              <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                  ...
                  <td noWrap height="25" width="85%" class="title4">
                    <font size="4">Main Route vs Rework Route Information</font>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="20" colspan="2">
				   <% if (t.equals("Show")) { %>
                        ...
                        <input type="button" name="Add" value="Add" class="button1" onclick="add('<%=sid%>','<bean:write name="MainRouteReFormX" property="product_body"/>','<bean:write name="MainRouteReFormX" property="version"/>','<bean:write name="MainRouteReFormX" property="route_type"/>');">
                  ...
                  <thead>
                    <tr class="list1">
                      <td height="20" align="left">
                        <font size="2">
                          <b>                            Product :
                             <bean:write name="MainRouteReFormX" property="product_body"/>
                             / Version
                             <bean:write name="MainRouteReFormX" property="version"/>
                          </b>
                        </font>
                      </td>
                    </tr>
                ...
                <table id="table27" cellspacing=1 cellpadding=0 class="table2">
                  <thead>
                    <tr class="title1">
                      ...
                      <td height="20" width="30%" >Rework Route</td>
                      <td height="20" width="47%" >Remark</td>

                    </tr>

                  </thead>
                  <logic:present name="mrrParam">
                    <logic:iterate id="result1" name="mrrParam" indexId="i">
                      <tr class="list1">
