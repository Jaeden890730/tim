...
FTTestActionForm[] rs3 = FTService.getVendorOIList(sidtmp);
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bg1" align="center">
          <tr>
            <td width="100%" height="490" valign="top">
              ...
              <form name="form1" action="<html:rewrite page="/OImaintain/cancellationAsignAction.do"/>?sid=<%=sid%>&pd_body=<bean:write name="list1" property="product_body"/>&brand=<bean:write name="list1" property="brand"/>&version=<bean:write name="list1" property="version"/>">
                  ...
                  <thead>
                   ...
                   <tr class="list1">
                      <td height="20" align="left">
                        <font size="2">
                        <b>                            Product :
                                <bean:write name="list1" property="product_body"/>
                                /
                    ...
                    <tr class="title1">
                      ...
                      <td align="left" height="20">
                        <logic:equal name="list1" property="brand" value="KH">
                        	<a href="#" onclick="downloadFile('8049k-<bean:write name="list1" property="product_body"/>v<bean:write name="list1" property="version"/>_tx.pdf')"><img border="0"  style="" name="image_new" src='<html:rewrite page="/image/pdf.gif"/>' alt=""></a>                        
                        </logic:equal>
                        <logic:notEqual name="list1" property="brand" value="KH">
                        	<a href="#" onclick="downloadFile('8049-<bean:write name="list1" property="product_body"/>v<bean:write name="list1" property="version"/>_tx.pdf')"><img border="0"  style="" name="image_new" src='<html:rewrite page="/image/pdf.gif"/>' alt=""></a>                        
                        </logic:notEqual>
                      </td>
                    </tr>
                       <tr class="title1">
                     ...
                     與前一版本差異比較PDF
                      ...
                      <td align="left" height="20">
                        <logic:equal name="list1" property="brand" value="KH">
                        	<a href="#" onclick="downloadFile('8049k-<bean:write name="list1" property="product_body"/>cv<bean:write name="list1" property="version"/>_tx.pdf')"><img border="0"  style="" name="image_new" src='<html:rewrite page="/image/pdf.gif"/>' alt=""></a>
                        </logic:equal>
                        <logic:notEqual name="list1" property="brand" value="KH">
                        	<a href="#" onclick="downloadFile('8049-<bean:write name="list1" property="product_body"/>cv<bean:write name="list1" property="version"/>_tx.pdf')"><img border="0"  style="" name="image_new" src='<html:rewrite page="/image/pdf.gif"/>' alt=""></a>
                        </logic:notEqual>
                      </td>
                    </tr>
